...
(async () => {
  try {
    ...
    const url = "https://www.walgreens.com/search/results.jsp?Ntt=coffee%20creamer&N=362398";
    ...
    await page.goto(url);
      ...
      const scrapeCurrentPage = async () => {
        ...
        const pageData = await page.evaluate(() => {
          ...
          return productElements.map((product) => {
            ...
            const titleElement = product.querySelector("strong.description");
            const priceElement = product.querySelector("span.product__price");
      ...
      const outputDirectory = "./coffe"; // Relative path to the 'coffe' directory
      const outputFilePath = path.join(__dirname, outputDirectory, "walgreen.xlsx");
